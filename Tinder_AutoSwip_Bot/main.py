...
password = driver.find_element(By.XPATH, valye='//*[@id="pass"]')
...
for n in range(100):
    # Ass a 1 second delay between likes
    sleep(1)
    ...
    # catches the cases where there is a Matched pop up in fron of the like button
    except ElementClickInterceptedException:
        try:
            match_popup = driver.find_element(By.CSS_SELECTPR, value=".itsAMatch a")
            match_popup.click()
